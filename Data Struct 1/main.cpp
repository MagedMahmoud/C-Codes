...
int main() {
    ...
    string transactionFileName = "transactionAccountsReceivable.txt";
    string masterFileName = "masterAccountsReceivable.txt";
    string newMasterFileName = "newMaster.txt";
    ...
    if(!openInputStream(masterFileStream, masterFileName)){
        ...
        cout << "Can't open transaction file.";
        return 1;
    }
    ...
    while (masterFileStream >> customer.customerNumber) {
        ...
        //
        //  Begin printing out the reciept
        //
        ...
        while (transactionFileStream >> transactionType) {
            ...
            if(!(transactionFileStream >> customerNumberPerTransaction)){
                cout << "Can't read customer number." << endl;
                return 1;
            }
            ...
            if (record.type == Payment) {
                ...
                if(!(transactionFileStream >> record.cashAmount)){
                    cout << "Can't read payment amount." << endl;
                    return 1;
                }
            }
